...
function exp_Lokasi_TMUlokasi_tmu_3rule0_eval_expression(context) {
    // kapasitas > 30

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('kapasitas')  > 30);
    } else {
        return (feature.get('kapasitas')  > 30);
    }
}
...
function exp_Lokasi_TMUlokasi_tmu_3rule1_eval_expression(context) {
    // kapasitas >= 10 AND kapasitas <= 30

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('kapasitas')  >= 10) && (feature.get('kapasitas')  <= 30));
    } else {
        return ((feature.get('kapasitas')  >= 10) && (feature.get('kapasitas')  <= 30));
    }
}
...
function exp_Lokasi_TMUlokasi_tmu_3rule2_eval_expression(context) {
    // kapasitas < 10

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('kapasitas')  < 10);
    } else {
        return (feature.get('kapasitas')  < 10);
    }
}